function [C,phi,S12,S1,S2,f,confC,phistd,Cerr,J1, J2]=coherencyc(data1,data2,params)
% Multi-taper coherency,cross-spectrum and individual spectra - continuous process
%
% Usage:
% [C,phi,S12,S1,S2,f,confC,phistd,Cerr,Jcond1,Jcond2]=coherencyc(data1,data2,params)
% Input: 
...
% STW 4/3/10 added 2 outputs: Jcond1, Jcond2 which represent fourier
% transforms of data1 and data2, respectively.
